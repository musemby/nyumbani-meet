...
sentry_sdk.init(
    dsn=os.getenv('SENTRY_DSN', 'https://432df80113f64d0786a15b93f227e6f2@o1383561.ingest.sentry.io/6700839'),
    integrations=[
        DjangoIntegration(),
    ],
...
OAUTH2_PROVIDER = {
    'SCOPES': {
        'delivery_requests': 'Access to delivery requests'
    }
}
...
# SMS
BUNICOM_SMS_URL = os.getenv('BUNICOM_SMS_URL', 'https://portal.bunicom.com/api/services/sendsms/')
BUNICOM_BULK_SMS_URL = os.getenv('BUNICOM_BULK_SMS_URL', 'https://api.bunicom.com/sendbulksms')
BUNICOM_SMS_DELIVERY_REPORT_URL = os.getenv('BUNICOM_SMS_DELIVERY_REPORT_URL', 'https://api.bunicom.com/getdlr')
...
PAYMENT_NOTIFICATION_EMAIL_PASSWORD = os.getenv('PAYMENT_NOTIFICATION_EMAIL_PASSWORD', 'pasuaaad')
PAYMENT_NOTIFICATION_EMAIL_SERVER = os.getenv('PAYMENT_NOTIFICATION_EMAIL_SERVER', 'some.imap.server')
...
INTASEND_PAYMENT_STATUS_URL = os.getenv('INTASEND_PAYMENT_STATUS_URL', 'api/v1/payment/status/')
INTASEND_REDIRECT_URL = os.getenv('INTASEND_REDIRECT_URL', 'https://vertafrica.bubbleapps.io/version-test/payment-confirmation')
...
# slack
RESERVED_PRODUCT_SLACK_CHANNEL = os.getenv('RESERVED_PRODUCT_SLACK_CHANNEL', 'C053JR50GBF')
